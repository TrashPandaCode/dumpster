...
The call to the state transition function is also provided with a time variable $t \\in \\mathbb{R}$ (see [Time and Game Loop](/docs/time-and-game-loop/game-loop)), which acts as an ordering dimension, defining a *before* and *after*.
