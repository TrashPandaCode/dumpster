...
{/*
Authors: Leo Kling
Purpose: Documentation for marker position reconstruction in motion capturing, including the calibration of camera parameters and the process of determining marker positions in space.
*/}
