import{o as n}from"./chunk-AYJ5UCUI-DfzbB4N7.js";const d={title:"Group"};function i(o){const e={em:"em",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...o.components},{DocsNodeEditor:t}=e;return t||l("DocsNodeEditor"),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{children:"Group"}),`
`,n.jsxs(e.p,{children:["The ",n.jsx(e.em,{children:"Group"})," node allows you to organize and encapsulate multiple nodes within a single container."]}),`
...
`,n.jsxs(e.li,{children:["Deleting a ",n.jsx(e.em,{children:"Group"})," node node will also delete all of its child nodes."]}),`
